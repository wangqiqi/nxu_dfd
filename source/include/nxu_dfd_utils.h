#ifndef __NXU_DFD_UTILS_H__
#define __NXU_DFD_UTILS_H__
...
namespace nxu_dfd_utils
{
    ...
    public:
        ...
        /* 用路径构造初始化模型 */
        CNXUDFDUtils(const std::string &modelPath);

        // 处理
        NXU_STATUS_CODE_E process(const NXU_IMAGE_S *pstImage);

        // 获得结果
        NXU_STATUS_CODE_E get_results(NXU_DFD_Result_S *pstResult);
